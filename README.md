...
This is a quick project that targets to bring all the camera that uses thingino firmware preview at one web page.  It will allow monitoring (and control) the cameras all at one place.  The quick camera access also allow fine tune the camera via web UI. 
Features:
